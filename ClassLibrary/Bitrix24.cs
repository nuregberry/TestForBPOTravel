...
namespace ClassLibrary
{
    ...
    public class Bitrix24
    {
        ...
        private const string BX_ClientSecret = "*******"; //Ваш Ключ приложения (client_secret)
        private const string BX_Portal = "https://b24-7mkfbh.bitrix24.ru"; //Адрес вашего портала\сайта в Битрикс24
        ...
        private void Connect()
        {
            ...
            HttpWebResponse responseLogonBitrix24;

            try
            {
                responseLogonBitrix24 = (HttpWebResponse)requestLogonBitrix24.GetResponse();
            }
            catch (WebException ex)
            {
                responseLogonBitrix24 = (HttpWebResponse)ex.Response; 
                if (responseLogonBitrix24.StatusCode != HttpStatusCode.Redirect) throw (ex);
            }
